...
class _CreateAccountState extends State<CreateAccountPage> {
  ...
  void _createAccount() async {
    ...
    // valida senha forte
    final erroSenha = _validarSenhaForte(passWordController.text);
    if (erroSenha != null) {
      ScaffoldMessenger.of(context).showSnackBar(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset("assets/images/img_criacao_senha.png", height: 200),
                ...
                viewModel.isLoading
                    ...
                    : ButtonAppWidget(onclick: _createAccount, title: "CADASTRAR"),
